...
lemma nonzero_mem_of_neq_bot [integral_domain R'] (I : ideal R') (neq_bot : I ≠ ⊥) : ∃ (a ∈ I), a ≠ (0 : R') :=
begin
  by_contradiction,
  push_neg at a,
  apply neq_bot,
...
begin
  by_cases I = ⊥,
  { use (0 : R'), use (0 : R'), rw h, simp,},
  have h1 := nonzero_mem_of_neq_bot R' I h,
  cases h1 with a a_mem,
  cases a_mem with a_mem a_neq_zero,
  use a,
  sorry,
end
end dedekind